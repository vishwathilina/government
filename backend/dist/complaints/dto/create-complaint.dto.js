...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Complaint type', example: 'BILLING_ISSUE' }),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Complaint description', example: 'Incorrect bill amount' }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
